    ...
    <section class="app-stage">
      <header class="top-bar">
        <div class="top-bar-left">
          <el-icon class="nav-logo" :size="34" aria-hidden="true"><DocumentChecked /></el-icon>
...
import { DocumentChecked, House, Search, Setting, User, SwitchButton, Sunny, Moon } from '@element-plus/icons-vue'
